...
impl<E: Engine, L: LockManager> Scheduler<E, L> {
    ...
    async fn process_write(self, snapshot: E::Snap, task: Task, statistics: &mut Statistics) {
        ...
        // message of the transfer leader command must be later than this write command
        // because this write command has been sent to the raftstore. Then, we
        // don't need to worry this request will fail due to the voluntary
        // leader transfer.
