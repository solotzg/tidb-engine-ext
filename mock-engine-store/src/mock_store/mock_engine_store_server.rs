...
pub fn gen_engine_store_server_helper(
    ...
    EngineStoreServerHelper {
        ...
        ps: PageStorageInterfaces {
            ...
            fn_ps_wb_put_page: Some(ffi_mockps_wb_put_page),
            fn_ps_wb_del_page: Some(ffi_mockps_wb_del_page),
            fn_ps_get_wb_size: Some(ffi_mockps_get_wb_size),
            fn_ps_is_wb_empty: Some(ffi_mockps_is_wb_empty),
            fn_ps_handle_merge_wb: Some(ffi_mockps_handle_merge_wb),
            fn_ps_handle_clear_wb: Some(ffi_mockps_handle_clear_wb),
            fn_ps_handle_consume_wb: Some(ffi_mockps_handle_consume_wb),
            fn_ps_handle_read_page: Some(ffi_mockps_handle_read_page),
            fn_ps_handle_scan_page: Some(ffi_mockps_handle_scan_page),
            fn_ps_handle_get_lower_bound: Some(ffi_mockps_handle_get_lower_bound),
            fn_ps_is_ps_empty: Some(ffi_mockps_is_ps_empty),
            fn_ps_handle_purge_ps: Some(ffi_mockps_handle_purge_ps),
        },
    }
}
