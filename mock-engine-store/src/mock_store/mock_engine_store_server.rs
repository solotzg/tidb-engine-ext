...
pub fn gen_engine_store_server_helper(
    ...
    EngineStoreServerHelper {
        ...
        fn_wb_put_page: Some(ffi_mockps_write_batch_put_page),
        fn_wb_del_page: Some(ffi_mockps_write_batch_del_page),
        fn_get_wb_size: Some(ffi_mockps_write_batch_size),
        fn_is_wb_empty: Some(ffi_mockps_write_batch_is_empty),
        fn_handle_merge_wb: Some(ffi_mockps_write_batch_merge),
        fn_handle_clear_wb: Some(ffi_mockps_write_batch_clear),
        fn_handle_consume_wb: Some(ffi_mockps_consume_write_batch),
        fn_handle_read_page: Some(ffi_mockps_handle_read_page),
        fn_handle_scan_page: Some(ffi_mockps_handle_scan_page),
        fn_handle_get_lower_bound: Some(ffi_mockps_handle_seek_ps_key),
        fn_is_ps_empty: Some(ffi_mockps_ps_is_empty),
        fn_handle_purge_ps: Some(ffi_mockps_handle_purge_pagestorage),
    }
}
