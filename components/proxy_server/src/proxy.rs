...
pub unsafe fn run_proxy(
    ...
    // We don't check if the value of argument 'engine-label' is same with 'ENGINE_LABEL_VALUE'(env
    // variable specified at compile time), because we need to distinguish TiFlash role
